...
__published:	// IDE-managed Components
	...
	void __fastcall WebModule1vrijemeActAction(TObject *Sender, TWebRequest *Request,
          TWebResponse *Response, bool &Handled);
	void __fastcall WebModule1pristupActAction(TObject *Sender, TWebRequest *Request,
          TWebResponse *Response, bool &Handled);
